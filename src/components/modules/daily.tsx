...
interface IProps {
  postOfTheDay: Resource | null;
  paths: Path[];
  path: Path | null;
}

export default function Daily({ postOfTheDay, paths, path }: IProps) {
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-12 text-center">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-slate-400">
                    We couldn't find a post for today. Try selecting a different
                    path or check back later.
                  </p>
                </div>
              </div>
            )}
