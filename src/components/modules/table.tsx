                ...
                >
                  <TableCell>
                    <RenderIcons
                      ...
                      bookmark={
                        resource.id ? bookmark.includes(resource.id) : false
                      }
                    />
                  </TableCell>
                  ...
                  {searchParams.columns.includes("tags") &&
                  ...
                  {searchParams.columns.includes("authors") &&
                  resource.authors !== undefined ? (
                    <TableCell>
                  ...
                  {searchParams.columns.includes("date") ? (
                    <TableCell>{resource.date}</TableCell>
                  ) : null}
                  {searchParams.columns.includes("time") ? (
                  ...
                  {searchParams.columns.includes("price") ? (
                    <TableCell>
                      {!resource.price ? "Free" : `${resource.price}€`}
                    </TableCell>
                  ) : null}
                  ...
                  <TableCell>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          className="h-8 w-8 p-0 hover:bg-indigo-900 hover:text-white"
                        >
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="bg-neutral-900 rounded-md w-[200px]"
                      >
                        <DropdownMenuItem
                        ...
                        >
                          {resource.id && !read.includes(resource.id)
                            ? "Mark as read"
                            : "Mark as not read"}
                        </DropdownMenuItem>
                        <DropdownMenuItem
                        ...
                        >
                          {resource.id && !bookmark.includes(resource.id)
                            ? "Bookmark"
                            : "Remove bookmark"}
                        </DropdownMenuItem>
                      </DropdownMenuContent>
...
export const ResourceTableFooter = ({
  searchParams,
  count,
}: {
  searchParams: SearchParams;
      ...
      <Button
        ...
        disabled={
          ...
          (count % ITEMS_PER_PAGE == 0
            ? Math.floor(count / ITEMS_PER_PAGE)
            : Math.floor(count / ITEMS_PER_PAGE) + 1)
        }
      >
        Next
      </Button>
